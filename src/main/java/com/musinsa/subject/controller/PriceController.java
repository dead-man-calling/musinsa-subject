...
public class PriceController {
    ...
    public Single<LowestPriceByCategoryResponse> getLowestPriceByCategory() {
        return new Single<>(facade.getLowestPriceByCategory());
    }
    ...
    @ResponseStatus(HttpStatus.OK)
    public Single<LowestTotalPriceBrandWithCategoryDetailsResponse> getLowestTotalPriceBrandWithCategoryDetails() {
        return new Single<>(facade.getLowestTotalPriceBrandWithCategoryDetails());
    }
    ...
    @ResponseStatus(HttpStatus.OK)
    public Single<MinMaxPriceBrandsByCategoryNameResponse> getMinMaxPriceBrandsByCategoryName(String categoryName) {
        return new Single<>(facade.getMinMaxPriceBrandsByCategoryName(categoryName));
    }
